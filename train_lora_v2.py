...
# ✅ Configure 4-bit GPU-only loading
...
# ✅ Fully GPU-loaded model
print("💪 Loading base model...")
model = AutoModelForCausalLM.from_pretrained(
    BASE_MODEL,
    quantization_config=bnb_config,
    device_map={"": 0},  # ✅ FORCE GPU ONLY (no CPU fallback)
    trust_remote_code=True,
)

print("🔧 Preparing for LoRA training...")
